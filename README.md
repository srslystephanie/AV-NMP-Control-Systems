...
The files for this plugin are in this repository. Work your way through the code provided (or feel free to start from scratch) and understand what is happening (the tutorial explains each method separately). 
